...
class proposition_fournisseursController extends Controller
{
    ...
    public function deleteAction($id)
    {
        ...
        $movie = $this->getDoctrine()->getEntityManager()->getRepository('AppBundle:proposition_fournisseur')->Find($id);
        ...
        return $this->redirectToRoute('proposition_fournisseur_index');
    }
