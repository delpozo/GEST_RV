...
function rechfournisseurs() {
    $('#fournisseurs').change ( function() {
        var motcle = $("#fournisseurs").val();
        $("#typeProduit option[value='1']").attr("selected ", true );
    $("#tab_vende").hide();
    $("#loading").show();
    $.ajax({
        type: "GET",
...
$().ready(function(){
    ...
    $sidebar_responsve = $('body > .navbar-collapse');
